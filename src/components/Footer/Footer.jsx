    ...
    return (
        <footer className="footer">
            <Container>
                ...
                <Row>
                    <Col lg="6" md='6'>
                        <p className="copyright__text">Copyright - 2022, website made by Sanjaya Ilham. All Rights Reserved.</p>
                    </Col>
                    ...
                    <Col lg="6" md='6'>
                        ...
                        gap-4 justify-content-end">
                            ...
                            <span><Link to='https://github.com/sanjayailham85'><i className="ri-github-line"></i></Link></span>
