       ...
       <Row>
            <Col lg='6' md='6'>
                <div className="hero__content">
                    ...
                    <h1 className="mb-4 hero__title"><span>Lorem ipsum</span> Lorem dolor Lorem.<span> ipsum dolor.</span></h1>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Alias, ea praesentium. Perspiciatis animi id adipisci.</p>
        ...
        <Container>
            <Row>
                <Col lg="12" className="text-center mt-20">
                    ...
                    <p className="mb-1 mt-4 feature__text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab, nostrum?</p>
                    <p className="feature__text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam, eligendi!</p>
                </Col>
        ...
        <Container>
            <Row>
                ...
                <Col lg="12">
                    ...
                    <button 
                        className={`all__btn ${category === 'ALL' ? 'deviceBtnActive' : '' }` } 
                        onClick={() => setCategory('ALL')}>
                        All
                    </button>

                    <button 
                        className={`d-flex align-items-center gap-2 ${category === 'SMARTPHONE' ? 'deviceBtnActive' : '' }` }
                    ...
                    <button 
                        className={`d-flex align-items-center gap-2 ${category === 'TABLET' ? 'deviceBtnActive' : '' }` } 
                ...
                <div className="why__device-shop mt-5">
                    ...
                    <ListGroup className="mt-4">
                        <ListGroupItem className="border-0 ps-0">
                            ...
                            <p className="choose__us-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, alias.</p>
                        </ListGroupItem>
        ...
        <Container>
            <Row>
                ...
                <Col lg="6" md="6">
                    ...
                    <p className="testimonial__desc mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore assumenda ut cumque minima maxime veritatis debitis a saepe, repellendus eaque?</p>
                ...
                <Col lg="6" md="6">
                    <img src={networkImg} alt="testimonial-img" className="w-100 mt-5" />
